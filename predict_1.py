...
def my_app(cfg: DictConfig) -> None:
    ...
    for dataset_name in ['LiveFActinDataset', 'MT']: 
        ...
        for model_name in ['dfcan', 'rcan', 'unet', 'wdsr', 'wgan']: 
            for batch_size in [1,2,4,8]:  
                for num_epochs in [1, 10, 50, 100, 200, 500]:                  
                    for lr, discriminator_lr in [(0.005, 0.005),(0.001, 0.001),(0.0005, 0.0005),(0.0002, 0.0002),(0.0001, 0.0001)]:
